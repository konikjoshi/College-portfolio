...
<div class="jumbotron text-center" style="margin: 300px; border-radius: 20px;">
    
  <h1>Thank You for Asking</h1>
    <h2 style="font-size: 20px;">we will send you reply as soon as possible [Stay tuned]</h2>
